...
class EquipmentDetailsUiModel {
  ...
  factory EquipmentDetailsUiModel.fromApiResponse(Data data) {
    return EquipmentDetailsUiModel(
      id: data.id ?? 0,
      date: data.date ?? "",
      ...
      amountDollar: data.amountDoller ?? "0",
